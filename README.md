...
1. Zbuduj **`Nixi.exe`** samodzielnie: `powershell -ExecutionPolicy Bypass -File scripts\build_windows.ps1` (albo uruchom workflow `.github/workflows/build-windows.yml` w GitHub Actions — artefakt `Nixi-windows-exe`).
