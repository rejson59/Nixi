...
- „co dalej / następne wydarzenie”: calendar_list range=dalej. Muzyka dalej/wstecz: phone next/prev.
- Powiadomienia: notifications_read. Pamięć bez pytania: memory_recall z pustym query.
